...
function enqueue_typekit_font() {
	wp_enqueue_style( 'trailhead-typekit', 'https://use.typekit.net/dqb6ktk.css', array(), null );
}
...
add_filter( 'wp_resource_hints', 'add_typekit_preconnect', 10, 2 ); 
  ...
  * Savvycal.
  */
function enqueue_savvycal_script() {
	?>
	<script>
...
add_action( 'wp_footer', 'enqueue_savvycal_script' );
