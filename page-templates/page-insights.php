						...
						<div class="grid-container">
							<div class="grid-x grid-padding-x">
								...
								<div class="cell small-12 medium-9">
									...
									<?php endif;?>
									<?=do_shortcode('[ajax_load_more id="alm_3756513388" post_type="post" scroll="false" posts_per_page="1" button_label="<span>See More</span>" button_loading_label="<span>Loading More...</span>"]');?>
								</div>
